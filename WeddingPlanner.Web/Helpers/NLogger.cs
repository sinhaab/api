        ...
        private void Log(TraceRecord record)
        {
            ...
            if (record.Exception != null)
            {
                ...
                else
                {
                    ...
                    message.Append("").Append("Exception Type: " + record.Exception.GetBaseException().GetType().ToString() + Environment.NewLine);
                    message.Append("").Append("Stack Trace: " + record.Exception.GetBaseException().StackTrace + Environment.NewLine);                                  
                }
            }
